...
#'   conda.env.create(env_name = "deathstar", env_file = "/path/to/requirements.txt")
#'   conda.env.create(env_file = "/path/to/requirements.txt", env_path = "/home/user/software/deathstar")
#' }
